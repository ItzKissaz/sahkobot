...
bot.on('message', async message => {
    ...
    if(message.content.startsWith(prefix + 'bal')) {
        ...
        var embed = new Discord.RichEmbed().addField(message.author.username + "Statd", "Balance 0/1000 Season 0").setColor(0x00ffff).setThumbnail(message.author.avatarURL)
