...
bot.on('message', async message => {
    ...
    if(message.content.startsWith(prefix + 'bal')) {
        ...
        var embed = new Discord.RichEmbed().addField(message.author.username, "Roles: " + message.member.roles.map(role => role.name).join(", ").addField("Stats", "XP: 0/100 Level 0")).setColor(0x00ffff).setThumbnail(message.author.avatarURL)
